...
Hero.prototype.update = function (platforms, hamburgers) {
    ...
    var mHeroBottom=this.getXform().getYPos() - 0.7*this.getXform().getHeight()/2;
    var mHeroTop=this.getXform().getYPos() + 0.7*this.getXform().getHeight()/2;
    var mHeroLeft=this.getXform().getXPos() - 0.7*this.getXform().getWidth()/2;
    var mHeroRight=this.getXform().getXPos() + 0.7*this.getXform().getWidth()/2;
...
Hero.prototype.Finish = function() {
    return this.getXform().getXPos() > 1000;
};
